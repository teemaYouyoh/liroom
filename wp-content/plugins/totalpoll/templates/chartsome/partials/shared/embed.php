...
<div class="totalpoll-choice-embed" data-tp-embed itemtype="http://schema.org/MediaObject">
	<?php if ( empty( $choice['content']['thumbnail']['url'] ) === false ): ?>
		<a href="javascript: void()" onclick="jQuery(this).closest('.totalpoll-choice-embed').addClass('run')" class="totalpoll-choice-embed-image totalpoll-choice-embed-image-<?php echo $choice['content']['type']; ?>">
