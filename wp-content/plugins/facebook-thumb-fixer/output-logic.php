        ...
        if (!is_archive()) {
			...
			//...otherwise, if there is no post image.
				...
				if ($taxonomy == '') {
					...
					$link = get_term_link($cat,$taxonomy);
				}
				$post_page_description = $cat->description;
				if ($post_page_description == '') $post_page_description = $blog_name . '-' . $name;
				//print_r($cat);
				$ftf_head = '
				<!--/ Facebook Thumb Fixer Open Graph /-->
				<meta property="og:type" content="'. $post_page_object_type . '" />
				<meta property="og:url" content="' . $link . '" />
				<meta property="og:title" content="' . str_replace('"', '', $name) . '" />
				<meta property="og:description" content="' . strip_shortcodes(str_replace('"', '', $post_page_description)) . '" />
				<meta property="og:site_name" content="' . str_replace('"', '', $blog_name) . '" />
				<meta property="og:image" content="' . get_option('default_fb_thumb') . '" />
