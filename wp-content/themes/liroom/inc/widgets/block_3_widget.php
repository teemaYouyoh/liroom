...
// Register the widget
add_action( 'widgets_init', create_function( '', 'return register_widget("liroom_Widget_Block_3");'));

// The widget class
class liroom_Widget_Block_3 extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'block3_widget', 'description' => esc_html__( "Display a list of posts based on one parent category.", 'liroom-lite') );
		parent::__construct('ft_block3', esc_html__('FT Block 3', 'liroom-lite'), $widget_ops);
	...
	public function form( $instance ) {
        ...
        <p>
			<label for="<?php echo $this->get_field_id( 'block_category' ); ?>"><?php esc_html_e('Block Category:', 'liroom-lite') ?></label>
