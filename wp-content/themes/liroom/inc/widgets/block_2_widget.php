...
// Register the widget
add_action( 'widgets_init', create_function( '', 'return register_widget("liroom_Widget_Block_2_Slider");'));

// The widget class
class liroom_Widget_Block_2_Slider extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'block2_widget', 'description' => esc_html__( "Slider posts widget for use on homepage.", 'liroom-lite') );
		parent::__construct('ft_block2', esc_html__('FT Block 2 - Slider', 'liroom-lite'), $widget_ops);
			...
			<article class="slider-item">
				<div class="slider-thumb">
					<a href="<?php the_permalink(); ?>">
						<?php the_post_thumbnail( 'liroom_slider' ); ?>
					</a>
				</div>
				<div class="slider-content">
					...
					<div class="slider-meta"><?php liroom_meta_1(); ?></div>
				</div>
			</article>
			<?php endwhile; ?>
		</div> <!-- .block_slider1 -->
	...
	public function form( $instance ) {
		...
		<p>
			...
			<small><?php echo esc_html_e( 'This widget only show posts has featured image.', 'liroom-lite' ); ?></small>
		</p>
		<p>
