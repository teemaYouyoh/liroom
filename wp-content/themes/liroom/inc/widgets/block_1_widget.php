...
// Register the widget
add_action( 'widgets_init', create_function( '', 'return register_widget("liroom_Widget_Block1");'));

// The widget class
class liroom_Widget_Block1 extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'block1_widget', 'description' => esc_html__( "Display posts with list or grid style for use on homepage.", 'liroom-lite') );
		parent::__construct('ft_block1', esc_html__('FT Block 1 - Recent Posts', 'liroom-lite'), $widget_ops);
	...
	public function widget( $args, $instance ) {
		...
		if ( $custom_query->have_posts() ) :
			...
			break;
			case('line'):
				echo '<div class="block1 block1_grid line">';
				echo '<div class="row">';
					while ( $custom_query->have_posts() ) : $custom_query->the_post();
					$count++;
					?>
