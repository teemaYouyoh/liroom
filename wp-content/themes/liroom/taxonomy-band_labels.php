			...
			<div id="primary" class="content-area">
			  ...
			  <div class="col-md-8 col-sm-6">
				<header class="page-header">
					<h1 class="page-title"><span>Розділ: Группы. Лейбл <?php echo $tag->name;?></span></h1>
				</header><!-- .page-header -->
			  </div>
			  <div class="col-md-4 col-sm-6">
			  <form role="search" method="get" class="search-albums-form search-form" action="/bands?search">
				<input type="search" class="search-albums-field" value="" placeholder="Введите, название группы" name="b" id="b">
				<input type="submit" class="search-albums-submit" value="Найти">
			  </form>
			  </div>
			  </div>
				<?php
