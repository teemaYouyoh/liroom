...
$right_sidebar = false;
$psort_a = array(
'date/DESC' => 'Від нових до старих',
'date/ASC' => 'Від старих до нових',
'meta_value_num/DESC' => 'Популярність за зростанням',
'meta_value_num/ASC' => 'Популярність за спаданням',
);
$psort = 'date/DESC';
			...
			<div id="primary" class="content-area">
			  ...
			  <div class="col-md-8 col-sm-6">
				<header class="page-header">
					<h1 class="page-title"><span>Розділ: Альбоми</span></h1>
				</header><!-- .page-header -->
			  </div>
			  <div class="col-md-4 col-sm-6">
			  <form action="/albums?psort" id="psort" method="get">
				...
				<?php
					...
					if ( $posts ) : 
						...
						echo '<div class="block1 block1_list custom">';
